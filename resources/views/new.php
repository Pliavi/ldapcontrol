                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <input type="number" name='userPrincipalName' class="form-control" required>
                                <!--<input type="number" name='sAMAccountName' class="form-control" placeholder="pre-Windows 2k">-->
                            </div>
                            <div class="col-md-10">
                                <label>Nome</label>
